...
void Logger::write_config_snapshot(int argc, char** argv) {
    ...
    config_file << "{\n"
                ...
                << "  \"use_biases\": " << bool_to_json(config_.use_biases) << ",\n"
                << "  \"visible_unit_precision\": " << bool_to_json(config_.visible_unit_precision) << ",\n"
                << "  \"state_init\": \"" << state_init_to_string(config_.state_init) << "\",\n"
                << "  \"error_precision_beta\": " << config_.error_precision_beta << ",\n"
                << "  \"error_precision_epsilon\": " << config_.error_precision_epsilon << ",\n"
                << "  \"error_precision_min\": " << config_.error_precision_min << ",\n"
                << "  \"error_precision_max\": " << config_.error_precision_max << ",\n"
                << "  \"transient_gate_tau\": " << config_.transient_gate_tau << ",\n"
                << "  \"sequential_inference\": " << bool_to_json(config_.sequential_inference) << ",\n"
